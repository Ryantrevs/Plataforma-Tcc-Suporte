...
namespace ConsultoriaApplication.Migrations
{
    ...
    [Migration("20201221182453_Add usuario que concluiu")]
    partial class Addusuarioqueconcluiu
    {
            ...
            modelBuilder.Entity("ConsultoriaApplication.Models.Card", b =>
                {
                    ...
                    b.Property<string>("UserConcludeId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("ConsultoriaApplication.Models.Card", b =>
                {
                    ...
                    b.HasOne("ConsultoriaApplication.Models.User", "UserConclude")
                        .WithMany()
                        .HasForeignKey("UserConcludeId");
                });
